...
No nosso banco de dados temos dois usuários: root e geek
...
c) Visualizando as Base de dados e Tabelas:
SHOW DATABASES;
SHOW TABLES;
...
-- Grant
GRANT SELECT ON tipos_produSELECT * FROM produtos;to TO geek;
