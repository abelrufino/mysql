...
INSERT INTO profissoes (cargo) VALUES ('Suporte Técnico');
INSERT INTO profissoes (cargo) VALUES ('Gerente');

SELECT * FROM profissoes;
SELECT * FROM clientes;

UPDATE profissoes set cargo = 'Suporte' 
WHERE id = 3;
...
SELECT c.nome, c.data_nascimento, c.telefone, p.cargo FROM clientes c , profissoes p
...
-- Cross Join
SELECT c.id, c.nome, c.data_nascimento, c.telefone, p.cargo FROM clientes AS c
